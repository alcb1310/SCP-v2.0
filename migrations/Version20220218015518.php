 ...
 */
final class Version20220218015518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actual_historico CHANGE casas casas DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actual_historico CHANGE casas casas INT DEFAULT NULL');
